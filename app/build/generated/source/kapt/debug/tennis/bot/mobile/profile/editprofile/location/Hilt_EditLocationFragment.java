...
public abstract class Hilt_EditLocationFragment extends LocationFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditLocationFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectEditLocationFragment(UnsafeCasts.<EditLocationFragment>unsafeCast(this));
    }
  }
}
