...
public abstract class Hilt_EditNameSurnameFragment<BINDING extends ViewBinding> extends CoreFragment<BINDING> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditNameSurnameFragment_GeneratedInjector) this.generatedComponent()).injectEditNameSurnameFragment(UnsafeCasts.<EditNameSurnameFragment>unsafeCast(this));
    }
  }
