...
public abstract class Hilt_EditPhoneFragment extends PhoneInputFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditPhoneFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectEditPhoneFragment(UnsafeCasts.<EditPhoneFragment>unsafeCast(this));
    }
  }
}
